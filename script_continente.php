...
if (isset($_POST['executar'])) {
    ...
    foreach ($lojasNodes as $lojaNode) {
        ...
        $endereco = $enderecoNode->length > 0 ? limparEspacos($enderecoNode->item(0)->textContent) : "N/A";
        ...
        $stmt = $conn->prepare("INSERT INTO lojas_continente (endereco, nome, latitude, longitude) VALUES (?, ?, ?, ?)");
        $stmt->bind_param("ssdd", $endereco, $nome, $latitude, $longitude);
        $stmt->execute();
    }
